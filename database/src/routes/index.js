...
router.post("/:model", validateModel, controllers.addDatabase);
...
router.delete("/:model/:id", validateModel, controllers.deleteDatabase);
...
router.put("/:model/:id",validateModel,controllers.updateDatabase);
